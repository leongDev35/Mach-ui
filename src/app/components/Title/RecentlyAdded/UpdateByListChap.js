...
export default function UpdateByListChap() {
    return (
        <div className="list-manga-update grid grid-cols-1 laptop:grid-cols-2 gap-2">
            <div className="item-list-manga-update">
                <div className="img-manga ">
                    <Image className="w-[144px] rounded"
                            ...
                            <div className="flex flex-col w-full justify-between px-1">
                                ...
                                <div>
                                    <div className="flex items-center justify-between gap-4">
                                        <div className="flex rating-recently-added gap-6">
